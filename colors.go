...
// named is the full set of CSS Color Module Level 4 extended keywords
// (the historical X11 list, 147 names including the gray/grey spelling
// pairs). The only rule is that each value must be a valid 6-digit hex
// colour.
